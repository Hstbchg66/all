...
BOT_TOKEN = getenv("BOT_TOKEN", "6661996163:AAH9iDQkedntHS2vMvc7L2gMKxnuZNM7hgo")
...
BOT_USERNAME = getenv("BOT_USERNAME", "MUSICALJEBOT")
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "6025090138").split()))
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6025090138").split())
...
NETWORK = getenv("NETWORK", "BXB_KING")
GROUP = getenv("GROUP", "BXB_KING")
